// https://github.com/Cumulocity-IoT/cumulocity-dynamic-mapper/blob/main/resources/samples/mappings-INBOUND.json
export const rules = [
  {
    id: "6725655",
    identifier: "l19zjk",
    ...
    targetTemplate:
      '{"measure1_Type":{"V":{"value":110,"unit":"C"}},"time":"2022-08-05T00:14:49.389+02:00","type":"c8y_TemperatureMeasurement"}',
    mappingType: "JSON",
    substitutions: [
      {
        pathSource:
          '_TOPIC_LEVEL_[1]&"_"&_TOPIC_LEVEL_[2]&"_"&$substringBefore(_TOPIC_LEVEL_[3],"_")',
  ...
  },
  {
    ...
    direction: "INBOUND",
    sourceTemplate:
      '{"mea":[{"tid":"uuid_01","psid":"Crest","devicePath":"path01_80_X03_VVB001StatusB_Crest","values":[{"value":4.6,"timestamp":1648562285347}]},{"tid":"uuid_02","psid":"Crest","devicePath":"path01_80_X03_VVB001StatusB_Crest","values":[{"value":5.6,"timestamp":1648563285347}]}]}',
    targetTemplate:
      '{"c8y_ProcessLoadMeasurement":{"L":{"value":110,"unit":"%"}},"time":"2022-08-05T00:14:49.389+02:00","source":{"id":"909090"},"type":"c8y_ProcessLoadMeasurement"}',
    mappingType: "JSON",
    substitutions: [
      {
      ...
      {
        pathSource:
          "$map($map(mea.values[0].timestamp, $number), function($v, $i, $a) { $fromMillis($v) })",
        pathTarget: "time",
        repairStrategy: "DEFAULT",
        expandArray: true,
      },
  ...
  },
  {
    ...
    direction: "INBOUND",
    sourceTemplate:
      '{"line":"Bus-Berlin-Rom","operator":"EuroBus","customFragment":{"customFragmentValue":"Express"},"capacity":64,"customArray":["ArrayValue1","ArrayValue2"],"customType":"type_International"}',
    targetTemplate:
      '{"c8y_IsDevice":{},"com_cumulocity_model_Agent":{},"name":"Bus Name","type":"type_bus","capacity":100,"id":"909090","time":"2022-08-05T00:14:49.389+02:00"}',
    mappingType: "JSON",
    substitutions: [
      {
  ...
  },
  {
    ...
    direction: "INBOUND",
    sourceTemplate:
      '{"msg_type":"c8y_BusStopEvent","txt":"Bus stopped at petrol station today!","td":"2022-09-08T16:21:53.389+02:00","ts":"1665473038000"}',
    targetTemplate:
      '{"source":{"id":"909090"},"text":"This is a new test event.","time":"2022-08-05T00:14:49.389+02:00","type":"c8y_GeneralBusEvent"}',
    mappingType: "JSON",
    substitutions: [
      {
        pathSource: "_TOPIC_LEVEL_[1]",
  ...
  },
  {
    ...
    direction: "INBOUND",
    sourceTemplate:
      '{"fuel":65,"ts":"2022-08-05T00:14:49.389+02:00","mea":"c8y_FuelMeasurement"}',
    targetTemplate:
      '{"c8y_FuelMeasurement":{"L":{"value":110,"unit":"L"}},"time":"2022-10-18T00:14:49.389+02:00","type":"c8y_FuelMeasurement"}',
    mappingType: "JSON",
    substitutions: [
      {
        pathSource: "_TOPIC_LEVEL_[1]",
  ...
  },
  {
    ...
    direction: "INBOUND",
    sourceTemplate:
      '{"device":["d1_id","d2_id"],"types":{"type_A":"type_A","type_B":"type_B"},"used_name":["Pressure_d1","Pressure_d2"]}',
    targetTemplate:
      '{"c8y_IsDevice":{},"name":"Vibration Sensor","type":"maker_Vibration_Sensor"}',
    mappingType: "JSON",
    substitutions: [
      {
        pathSource: "device",
      ...
      {
        pathSource:
          "$map(used_name, function($v, $i, $a) { $contains($v,'d1') ? $join(['Special_i0', $string($i)]) : $join([$string($v), $string($i)]) } )",
        pathTarget: "name",
        repairStrategy: "DEFAULT",
        expandArray: true,
      },
  ...
  },
  {
    ...
    substitutions: [
      ...
      {
        pathSource:
          "$map($map($[].values[0].timestamp, $number), function($v) { $fromMillis($v)})",
        pathTarget: "time",
        repairStrategy: "DEFAULT",
        expandArray: true,
      },
  ...
  },
  {
    ...
    direction: "INBOUND",
    sourceTemplate:
      '{"msg_type":"c8y_BusStopEvent","txt":"Bus stopped at petrol station today!","td":"2022-09-08T16:21:53.389+02:00","model":{"name":"MAN e-Bus"}}',
    targetTemplate:
      '{"text":"This is a new test event.","time":"2022-08-05T00:14:49.389+02:00","type":"c8y_TestEvent","customProperties":"dummy"}',
    mappingType: "JSON",
    substitutions: [
      {
        pathSource: "_TOPIC_LEVEL_[1]",
  ...
  },
  {
    ...
    direction: "INBOUND",
    sourceTemplate:
      '{"fuel":65,"oil":4.5,"ts":"2022-08-05T00:14:49.389+02:00","mea":"c8y_FuelMeasurement"}',
    targetTemplate:
      '{"c8y_FuelMeasurement":{"Tank":{"value":110,"unit":"l"}},"c8y_OilMeasurement":"undefined","time":"2022-08-05T00:14:49.389+02:00","type":"c8y_FuelMeasurement"}',
    mappingType: "JSON",
    substitutions: [
      {
        pathSource: "_TOPIC_LEVEL_[1]",
  ...
  },
  {
    ...
    name: "Mapping - 10",
    mappingTopic: "hex/+",
    mappingTopicSample: "hex/berlin_01",
    targetAPI: "EVENT",
    direction: "INBOUND",
    sourceTemplate: "{}",
    targetTemplate:
  ...
  },
  {
    ...
    targetTemplate:
      '{"description":"New camera operation!","type":"maker_Vibration_Sensor"}',
    mappingType: "JSON",
    substitutions: [
      {
        pathSource: "_TOPIC_LEVEL_[1]",
  ...
  },
  {
    ...
    targetTemplate:
      '{"text":"This is a new test event.","time":"2022-08-05T00:14:49.389+02:00","type":"c8y_TestEvent"}',
    mappingType: "HEX",
    substitutions: [
      {
  ...
  },
  {
    ...
    targetTemplate:
      '{"c8y_GenericMeasurement":{"Module":{"value":110,"unit":"l"}},"time":"2022-08-05T00:14:49.389+02:00","type":"c8y_GenericMeasurement_type"}',
  ...
  },
  {
    ...
    direction: "INBOUND",
    sourceTemplate:
      '{"deviceId":"909090","description":"This is a new test event.","time":"2022-08-05T00:14:49.389+02:00","eventType":"TestEvent"}',
    targetTemplate:
      '{"text":"This is a new test event.","time":"2022-08-05T00:14:49.389+02:00","type":"c8y_TestEvent"}',
    ...
    snoopedTemplates: [],
    extension: {
      extensionName: "dynamic-mapper-extension",
  ...
  },
  {
    ...
    direction: "INBOUND",
    sourceTemplate:
      '{"deviceId":"863859042393327","version":"1","deviceType":"20","deviceTimestamp":"1665473038000","deviceStatus":"BTR","temperature":90}',
    targetTemplate:
  ...
  },
  {
    ...
    sourceTemplate:
      '{"deviceId":"863859042393327","version":"1","deviceType":"20","deviceTimestamp":"1665473038000","deviceStatus":"BTR","temperature":90}',
    targetTemplate:
      '{"text":"New device status: BTR!","time":"2022-11-24T00:14:49.389+02:00","type":"c8y_GeneralPanelEvent"}',
    mappingType: "JSON",
    substitutions: [
      {
        pathSource: "deviceId",
  ...
  },
  {
    ...
    direction: "INBOUND",
    sourceTemplate:
      '{"Measurementname":"Airsensor","Seriesname":"Humidity","value":10,"unit":"%"}',
    targetTemplate:
      '{"Airsensor":"dummy","Liquidsensor":"dummy","time":"2022-08-05T00:14:49.389+02:00","type":"c8y_measurementtype"}',
    mappingType: "JSON",
    substitutions: [
      {
        pathSource: "_TOPIC_LEVEL_[1]",
      ...
      {
        pathSource:
          'Measurementname = "Airsensor" ? {Seriesname:{"value": value, "unit": unit}} : null',
      ...
      {
        pathSource:
          'Measurementname = "Liquidsensor" ? {Seriesname:{"value": value, "unit": unit}} : null',
  ...
  },
  {
    ...
    direction: "INBOUND",
    sourceTemplate:
      '{"msg_type":"c8y_FlatTireAlarm","tx":"Left rear tire loses air!","bus_id":"berlin_01"}',
    targetTemplate:
      '{"type":"c8y_FlatTireAlarm","text":"Left rear tire loses air!","severity":"MAJOR","status":"ACTIVE","time":"2022-03-19T12:03:27.845Z"}',
    mappingType: "JSON",
    substitutions: [
      {
        pathSource: "bus_id",
  ...
  },
  {
    ...
    sourceTemplate:
      '{"Temperature":{"value":110,"unit":"C"},"time":"2022-08-05T00:14:49.389+02:00","deviceId":"909090"}',
    targetTemplate:
      '{"time":"2022-08-05T00:14:49.389+02:00","type":"c8y_Temperature","c8y_Temperature":"dummy","c8y_Fragment_to_remove":"remove_me"}',
    mappingType: "EXTENSION_SOURCE",
    substitutions: [],
    active: true,
    debug: false,
  ...
  },
  {
    ...
    direction: "INBOUND",
    sourceTemplate:
      '{"values":[{"key":"velocidad_cabezal","value":136.34},{"key":"temperature","value":25}]}',
    targetTemplate:
      '{"time":"2022-08-05T00:14:49.389+02:00","type":"c8y_FlexibleMeasurement"}',
    mappingType: "JSON",
    substitutions: [
      {
        pathSource: "_TOPIC_LEVEL_[2]",
  ...
  },
  {
    ...
    substitutions: [
      ...
      {
        pathSource:
          "$map(values, function ($v) { {$v.key: {'Measurement':{'value':$v.value, 'unit': 'U'}}}})",
        pathTarget: "$",
        repairStrategy: "CREATE_IF_MISSING",
        expandArray: true,
      },
  ...
  },
  {
    ...
    direction: "INBOUND",
    sourceTemplate:
      '{"ID":"0018","meas":{"Product1_Flow":[14.93],"Water_Flow":[18.54],"Product2_Flow":[272.9]},"ts":"2024-06-18 13:20:45.000Z","timestampUTC":"2024-06-18T13:20:45.000Z"}',
    targetTemplate:
      '{"onguardMeasurement":null,"time":"2022-08-05T00:14:49.389+02:00","type":"onguardMeasurement"}',
    mappingType: "JSON",
    substitutions: [
      {
        pathSource: "ID",
      ...
      {
        pathSource:
          '$map($spread(meas), function($v, $k) { { $keys($v): { "value": $lookup($v,$keys($v))[0], "unit": "l/h" } } })~>$merge()',
  ...
  },
  {
    ...
    direction: "INBOUND",
    sourceTemplate:
      '{"deviceId":"909090","alarmType":"TestAlarm","description":"This is a new test alarm!","severity":"MAJOR","status":"ACTIVE","time":"2022-08-05T00:14:49.389+02:00"}',
    targetTemplate:
      '{"severity":"MAJOR","status":"ACTIVE","text":"This is a new test alarm!","time":"2022-08-05T00:14:49.389+02:00","type":"c8y_TestAlarm"}',
  ...
  },
  {
    ...
    direction: "INBOUND",
    sourceTemplate:
      '{"msg_type":"c8y_FlatTireAlarm","tx":"Left rear tire loses air!","bus_c8ySourceId":"10203040"}',
    targetTemplate:
      '{"type":"c8y_FlatTireAlarm","text":"Left rear tire loses air!","severity":"MAJOR","status":"ACTIVE","time":"2022-03-19T12:03:27.845Z"}',
    mappingType: "JSON",
    substitutions: [
