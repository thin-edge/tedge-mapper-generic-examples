...
(function(global, factory) { /* global define, require, module */
    ...
    $root.sensorpackage = (function() {
        ...
        sensorpackage.SensorMessage = (function() {
             ...
             * @returns {$protobuf.Writer} Writer
             */
            SensorMessage.encodeDelimited = function encodeDelimited(message, writer) {
            ...
            SensorMessage.decode = function decode(reader, length, error) {
                ...
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.sensorpackage.SensorMessage();
            ...
            SensorMessage.fromObject = function fromObject(object) {
                if (object instanceof $root.sensorpackage.SensorMessage)
                    return object;
