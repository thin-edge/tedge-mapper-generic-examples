...
export namespace sensorpackage {
    ...
    class SensorMessage implements ISensorMessage {
         ...
         */
        public static create(properties?: sensorpackage.ISensorMessage): sensorpackage.SensorMessage;
         ...
         * @returns Writer
         */
        public static encode(message: sensorpackage.ISensorMessage, writer?: $protobuf.Writer): $protobuf.Writer;
         ...
         * @returns Writer
         */
        public static encodeDelimited(message: sensorpackage.ISensorMessage, writer?: $protobuf.Writer): $protobuf.Writer;
         ...
         */
        public static decode(reader: ($protobuf.Reader|Uint8Array), length?: number): sensorpackage.SensorMessage;
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        public static decodeDelimited(reader: ($protobuf.Reader|Uint8Array)): sensorpackage.SensorMessage;
         ...
         * @returns SensorMessage
         */
        public static fromObject(object: { [k: string]: any }): sensorpackage.SensorMessage;
         ...
         */
        public static toObject(message: sensorpackage.SensorMessage, options?: $protobuf.IConversionOptions): { [k: string]: any };
